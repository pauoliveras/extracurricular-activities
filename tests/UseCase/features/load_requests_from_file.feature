Feature: Load requests from file
  ...
  Scenario: Load data from csv
    ...
    """
    email;candidate;group;desired_activity_count;is_member;option1;option2;option3;option4;option5
    ...
    And candidate "candidate 1|group 1" has been registered with "piscina,anglès,ioga,dansa,circ" ordered requests
    And candidate "candidate 2|group 2" has been registered with "ioga,anglès,piscina,circ" ordered requests
    And candidate "candidate 3|group 1" has been registered with "circ,ioga,dansa,piscina,anglès" ordered requests
    And candidate "candidate 4|group 2" has been registered with "ioga,dansa,circ" ordered requests

  Scenario: Load data from csv with max activities
    Given a file named "var/data/tests/requests.csv" with the following content
    """
    email;candidate;group;desired_activity_count;is_member;option1;option2;option3;option4;option5
    user1@gmail.com;candidate 1;group 1;3;yes;piscina;anglès;ioga;dansa;circ
    user1@gmail.com;candidate 2;group 2;;yes;ioga;anglès;piscina;circ
