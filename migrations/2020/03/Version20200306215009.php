...
final class Version20200306215009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE requested_activity ADD CONSTRAINT FK_848B639191BD8781 FOREIGN KEY (candidate_id) REFERENCES candidate (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE requested_activity DROP FOREIGN KEY FK_848B639191BD8781');
        $this->addSql('DROP TABLE requested_activity');
